...
export default function VisualSectionTopic({
  topicId,
  squareUrl,
  rectUrl,
  onUpdated,
  ...
  async function upload(file: File, format: "square" | "rectangle") {
    ...
    try {
      ...
      const res = await api.post("/visuals/topic/upload", {
        id_topic: topicId,
        format,
        base64_image: base64,
      });
      ...
      console.error(e);
      alert("❌ Erreur upload visuel topic");
    }
  ...
  async function resetVisuals() {
    ...
    try {
      const res = await api.post("/visuals/topic/reset", {
        id_topic: topicId,
      });
      ...
      console.error(e);
      alert("❌ Erreur reset visuels topic");
    }
